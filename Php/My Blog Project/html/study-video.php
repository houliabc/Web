...
<head>
    ...
    <link rel="icon" href="../images/icon/video.png">
            ...
            <div id="right">
                ...
                <div id="row">
                    <!-- 第一行图片 -->
                        ...
                        <div id="video">
                            <div id="vid1">
                                <video controls muted src="../video/s1.mp4"></video>
                            </div>
                            <div id="name1">
                                <h3>htnl5概述1</h3>
                            </div>
                        ...
                        <div id="video">
                            <div id="vid2">
                                <video  controls muted src="../video/s2.mp4"></video>
                            </div>
                            <div id="name2">
                                <h3>html5概述2</h3>
                            </div>
                ...
                <div id="next">
                    ...
                    <a href="study-video2.php#two" class="next round">&#8250;</a>
                </div>
            </div>
        </div>
