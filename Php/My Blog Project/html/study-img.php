            ...
            <div id="right">
                ...
                <div id="row">
                    <!-- 第一行图片 -->
                        ...
                        <div class="left">
                            <div id="img1">
                                <a href="../images/s1.png" download="圆的方程"><img src="../images/s1.png"></a>
                            </div>
                            <div id="name1">
                                圆的方程
                            </div>
                        ...
                        <div class="right">
                            <div id="img2">
                                <a href="../images/s2.png" download="英语作文"><img src="../images/s2.png"></a>
                            </div>
                            <div id="name2">
                                英语作文
                            </div>
                ...
                <div id="row">
                        ...
                        <div class="left">
                            <div id="img1">
                                <a href="../images/s3.png" download="史纲"><img src="../images/s3.png"></a>
                            </div>
                            <div id="name1">
                                史纲
                            </div>
                        ...
                        <div class="right">
                            <div id="img2">
                                <a href="../images/s4.png" download="英语语法"><img src="../images/s4.png"></a>
                            </div>
                            <div id="name2">
                                英语语法
                            </div>
                ...
                <div id="next">
                    ...
                    <a href="study-img2.php#two" class="next round">&#8250;</a>
                </div>
            </div>
        </div>
